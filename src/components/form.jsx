...
export function Form () {
  ...
  return (
          <div ref={sectionRefs.section5} className="w-full px-4 md:px-0 pb-10 md:pb-20">
            <div className="pt-10 max-w-[1100px] mx-auto">
            <h1 className="font-bold text-2xl md:text-4xl pb-4 ">6. Kontaktinformationen</h1>
          ...
          <div className="mb-4">
            ...
            <div className="flex">
              ...
              <input
                type="tel"
                placeholder="Phone"
                className="w-3/5 border border-gray-300 p-1.5 rounded-md"
                {...register('phone')}
              />
            </div>
          </div>
